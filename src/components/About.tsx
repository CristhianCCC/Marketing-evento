            ...
            <div className="grid lg:grid-cols-2 gap-2 items-center px-4 lg:px-20 xl:px-60">
                <div>
                    <p className="text-white text-lg lg:text-xl leading-relaxed text-center lg:text-left">
                        ...
                        Es un espacio para soltar la autoexigencia, el autosabotaje y la mentalidad de carencia que muchas personas arrastran mientras intentan construir algo afuera.
                        Aquí vas a reconectarte contigo mismo, con tu valor, tu propósito y tu capacidad de liderar tu vida personal y empresarial desde un lugar auténtico: el amor propio.
