...
export default function Navbar () {
    ...
    return (
        ...
        <nav>
            ...
            <ul className={`rounded-2xl p-5 flex lg:justify-evenly justify-between items-center bg-gray-900 shadow-2xl gradient-pink font-bold overflow-hidden duration-300 ease-out ${menuOpen ? 'flex-col-reverse max-h-96 opacity-100' : 'max-h-0 opacity-0'} lg:max-h-none lg:opacity-100`}>
